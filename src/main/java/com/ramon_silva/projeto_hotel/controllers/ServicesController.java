...
public class ServicesController {
    ...
    @PutMapping("{id}")
    @Transactional
    public ResponseEntity<ServicesDto> updateById(@PathVariable(name = "id") @Positive Long id,@RequestBody @Valid ServicesDto roomDto){
    ...
    @GetMapping("{id}")
    public ResponseEntity<ServicesDto> getById(@PathVariable(name = "id") Long id){
