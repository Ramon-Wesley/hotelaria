...
public class ReservationCreator {
    ...
    public static ReservationModel newReservationModel() {
        ...
        roomModel.setId(1L);
        return new ReservationModel(null, guestModel, roomModel, oneWeekLater, oneWeekFiveDaysLater, StatusEnum.CONFIRM,
                total_pay, reservation_serviceModel);
    }
    ...
    public static ReservationModel newReservationModel2() {
        ...
        roomModel.setId(2L);
        double total_pay = calculateTotalPay(daysDifference, roomModel.getPrice());
        return new ReservationModel(null, guestModel, roomModel, oneWeekLater, oneWeekFiveDaysLater, StatusEnum.PENDING,
                total_pay, reservation_serviceModel);
    }
