...
public class ClientCreator {
    ...
    public static ClientDto createNewClient(){
        AddressDto addressDto=new AddressDto(2L, "Brasil", "minas gerais","35.117.222", "coronel fabriciano", "gavea", "116", "hjhdj");
        return new ClientDto(2L, "Client2", "511.438.760-08","Ramonw1sj.s@gmail.com","031 98888-8888", addressDto);
    }
